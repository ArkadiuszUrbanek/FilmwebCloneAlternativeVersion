...
3. [Internal specification](#internal-specification)  
4. [External specification](#external-specification)  
...
Frameworks used in the client-side application
...
Libraries used in the client-side application
...
Frameworks used in the server-side application

- **ASP.NET Core** – An open-source, cross-platform framework used for building web applications.

Libraries used in the server-side application
...
Database used in the server-side application
