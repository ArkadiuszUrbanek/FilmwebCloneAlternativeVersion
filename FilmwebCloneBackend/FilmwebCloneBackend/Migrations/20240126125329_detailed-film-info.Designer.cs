...
namespace FilmwebCloneBackend.Migrations
{
    ...
    [Migration("20240126125329_detailed-film-info")]
    partial class detailedfilminfo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Forum", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 1, 26, 12, 53, 29, 428, DateTimeKind.Utc).AddTicks(5491));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 26, 12, 53, 29, 428, DateTimeKind.Utc).AddTicks(2672));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Review", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 26, 12, 53, 29, 428, DateTimeKind.Utc).AddTicks(7382));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 26, 12, 53, 29, 428, DateTimeKind.Utc).AddTicks(2208));
