...
namespace FilmwebCloneBackend.Migrations
{
    ...
    [Migration("20240128014435_removed-forum-description")]
    partial class removedforumdescription
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Forum", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 1, 28, 1, 44, 35, 831, DateTimeKind.Utc).AddTicks(3585));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 28, 1, 44, 35, 831, DateTimeKind.Utc).AddTicks(1608));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Review", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 28, 1, 44, 35, 831, DateTimeKind.Utc).AddTicks(4882));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 28, 1, 44, 35, 831, DateTimeKind.Utc).AddTicks(1181));
