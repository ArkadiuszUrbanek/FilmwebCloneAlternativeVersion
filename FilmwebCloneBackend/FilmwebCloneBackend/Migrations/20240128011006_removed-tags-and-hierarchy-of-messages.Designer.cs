...
namespace FilmwebCloneBackend.Migrations
{
    ...
    [Migration("20240128011006_removed-tags-and-hierarchy-of-messages")]
    partial class removedtagsandhierarchyofmessages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Forum", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 1, 28, 1, 10, 6, 605, DateTimeKind.Utc).AddTicks(7197));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 28, 1, 10, 6, 605, DateTimeKind.Utc).AddTicks(5259));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Review", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 28, 1, 10, 6, 605, DateTimeKind.Utc).AddTicks(8473));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 28, 1, 10, 6, 605, DateTimeKind.Utc).AddTicks(4840));
