...
namespace FilmwebCloneBackend.Migrations
{
    ...
    [Migration("20240115155929_initial_migration")]
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Forum", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 1, 15, 15, 59, 29, 269, DateTimeKind.Utc).AddTicks(2531));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 15, 15, 59, 29, 269, DateTimeKind.Utc).AddTicks(92));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Review", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 15, 15, 59, 29, 269, DateTimeKind.Utc).AddTicks(4304));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 15, 15, 59, 29, 268, DateTimeKind.Utc).AddTicks(9719));
