...
namespace FilmwebCloneBackend.Migrations
{
    ...
    [Migration("20240125120530_film_genre")]
    partial class film_genre
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Forum", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 1, 25, 12, 5, 30, 343, DateTimeKind.Utc).AddTicks(9438));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 25, 12, 5, 30, 343, DateTimeKind.Utc).AddTicks(6665));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Review", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 25, 12, 5, 30, 344, DateTimeKind.Utc).AddTicks(1273));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 25, 12, 5, 30, 343, DateTimeKind.Utc).AddTicks(6261));
