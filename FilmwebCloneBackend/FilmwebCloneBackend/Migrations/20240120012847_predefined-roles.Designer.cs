...
namespace FilmwebCloneBackend.Migrations
{
    ...
    [Migration("20240120012847_predefined-roles")]
    partial class predefinedroles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Forum", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 1, 20, 1, 28, 47, 278, DateTimeKind.Utc).AddTicks(1834));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 20, 1, 28, 47, 277, DateTimeKind.Utc).AddTicks(9226));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.Review", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 20, 1, 28, 47, 278, DateTimeKind.Utc).AddTicks(3564));
            ...
            modelBuilder.Entity("FilmwebCloneBackend.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 20, 1, 28, 47, 277, DateTimeKind.Utc).AddTicks(8831));
